...
export const icons = [
    {_id: '1', href: '/#', class: 'fa fa-facebook'},
    {_id: '2', href: '/#', class: 'fa fa-twitter'},
    {_id: '3', href: '/#', class: 'fa fa-rss'},
    {_id: '4', href: '/#', class: 'fa fa-vk'},
]

export const categories = [
    {
        navBarNav: [
            {_id: '1', href: '#banner', class: 'active', title: 'Главная'},
            {_id: '2', href: '#about', class: 'scroll', title: 'О нас'},
            {_id: '3', href: '#gallery', class: 'scroll', title: 'Галерея'},
            {_id: '4', href: '#team', class: 'scroll', title: 'Сотрудники'},
            {_id: '5', href: '#services', class: 'scroll', title: 'Перечень услуг'},
            {_id: '6', href: '#contact', class: 'scroll', title: 'Контакты'},
        ],
        navbarHeader: [
